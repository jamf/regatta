...
type RangeResponse struct {
	...
	Kvs []*proto.KeyValue `protobuf:"bytes,3,rep,name=kvs,proto3" json:"kvs,omitempty"`
...
func (x *RangeResponse) GetKvs() []*proto.KeyValue {
	if x != nil {
		return x.Kvs
	}
	return nil
...
type PutResponse struct {
	...
	PrevKv *proto.KeyValue `protobuf:"bytes,2,opt,name=prev_kv,json=prevKv,proto3" json:"prev_kv,omitempty"`
}
...
func (x *PutResponse) GetPrevKv() *proto.KeyValue {
	if x != nil {
		return x.PrevKv
	}
	return nil
...
type DeleteRangeResponse struct {
	...
	PrevKvs []*proto.KeyValue `protobuf:"bytes,3,rep,name=prev_kvs,json=prevKvs,proto3" json:"prev_kvs,omitempty"`
}
...
func (x *DeleteRangeResponse) GetPrevKvs() []*proto.KeyValue {
	if x != nil {
		return x.PrevKvs
	}
	return nil
...
var file_regatta_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x28, 0x5a, 0x26,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x6e, 0x64, 0x65,
	0x72, 0x61, 0x2f, 0x72, 0x65, 0x67, 0x61, 0x74, 0x74, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_regatta_proto_goTypes = []interface{}{
	...
	(*proto.KeyValue)(nil),      // 12: mvcc.v1.KeyValue
}
